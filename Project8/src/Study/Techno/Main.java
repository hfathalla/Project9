...
public class Main {
    ...
    public static void main(String[] args)  {
        ...
        element.get(1).sendKeys("Egyption88");
       ...
       WebElement nation = driver.findElement(By.xpath("//*[contains(text(),'Egyption88')]"));
        nation.click();
        WebElement edit=driver.findElement(By.xpath("//input[@ id='ms-text-field-2']"));
       edit.clear();
      edit.sendKeys("Egyption88");

      // cick on delete button
       ...
       driver.findElement(By.xpath("//*[contains(text(),'Egyption88')]")).findElement(By.xpath("//button[@class='mat-button mat-button-base mat-warn ng-star-inserted']")).click();
